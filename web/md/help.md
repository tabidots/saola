...
Type any Vietnamese or English word in the search box.

If you type a Vietnamese word with a tone mark, Saola will try to find an exact match, although entering words without tone marks is also fine (e.g., “the gioi” finds “thế giới”).

Typing ambiguous words like “the” and “may” will bring up results in both languages. You can collapse the section headings so that it is easier to find the section you are looking for.
...
- Other Southern long vowels `iê`-`uô`-`ươ` are denoted by the nonstandard spellings *ii, uu, ưư*
- `oc`-`ôc`-`uc` and `ong`-`ông`-`ung` are written as *aocp*, *âungm*, etc. (This does **not** apply to `uôc`-`uông`. Also, keep in mind the `o` in this case is also not pure.) This is necessary to distinguish the Southern pronunciation of the finals in groups like these:
  - lon, lòng = *loong, làongm*
  - bún, bụng = *búng, bụngm*
  - lúc/lụt, luộc = *lúcp, luục*
  - luận, luôn = *lụng, luung*
  - cuốn, cũng = *cuúng, cũngm*
  - thuộc, thuật, thúc = *thuục, thục, thúcp*
  - chuẩn, chuồn, chuông, chùm, chung = *chủng, chuùng, chuung, chùm, chúngm*
