...
Handlebars.registerHelper('linkify', function (text, offsets) {
    // Handlebars sometimes passes options instead of undefined → normalize
    const realOffsets = Array.isArray(offsets) ? offsets : [];
    const segs = segmentVietnamese(text, realOffsets);
...
// Vietnamese headword template
export const vnHeadwordTemplate = Handlebars.compile(`
<div class="result">
