var ae={\u00F3a:"o\xE1",\u00F2a:"o\xE0",\u1ECFa:"o\u1EA3",\u00F5a:"o\xE3",\u1ECDa:"o\u1EA1",\u00F3e:"o\xE9",\u00F2e:"o\xE8",\u1ECFe:"o\u1EBB",\u00F5e:"o\u1EBD",\u1ECDe:"o\u1EB9",\u00FAy:"u\xFD",\u00F9y:"u\u1EF3",\u1EE7y:"u\u1EF7",\u0169y:"u\u1EF9",\u1EE5y:"u\u1EF5",\u00D3a:"O\xE1",\u00D2a:"O\xE0",\u1ECEa:"O\u1EA3",\u00D5a:"O\xE3",\u1ECCa:"O\u1EA1",\u00D3e:"O\xE9",\u00D2e:"O\xE8",\u1ECEe:"O\u1EBB",\u00D5e:"O\u1EBD",\u1ECCe:"O\u1EB9",\u00DAy:"U\xFD",\u00D9y:"U\u1EF3",\u1EE6y:"U\u1EF7",\u0168y:"U\u1EF9",\u1EE4y:"U\u1EF5"};function P(e){let t=/([óòỏõọÓÒỎÕỌ][ae]|[úùủũụÚÙỦŨỤ]y)\b/g;return e.replace(t,s=>ae[s]||s)}function O(e){let t={"\u0300":"","\u0301":"","\u0309":"","\u0303":"","\u0323":""},s=e.normalize("NFD"),n="";for(let r of s)n+=t[r]??r;return n.normalize("NFC")}function G(e){let t=e.replace(/\u0110/g,"D").replace(/\u0111/g,"d");return t=t.normalize("NFKD"),t=t.replace(/[\u0300-\u036f]/g,""),t}function y(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function A(e){let s=await(await fetch(e)).blob(),n=new DecompressionStream("gzip"),r=s.stream().pipeThrough(n),a=await new Response(r).text();return JSON.parse(a)}RegExp.escape||(RegExp.escape=function(e){return String(e).replace(/[\\^$*+?.()|[\]{}]/g,"\\$&")});function U(e,t=[]){if(!t||t.length===0)return y(e);let s=y(e),n=[...t].sort((a,l)=>l.length-a.length),r=[];for(let a of n){let l=RegExp.escape(a),u=new RegExp(`(?<![\\p{L}\\p{M}])(${l})(?![\\p{L}\\p{M}])`,"gui"),f="",d=0,o,i=new RegExp(u.source,u.flags);for(;(o=i.exec(s))!==null;){let c=o.index,g=o.index+o[0].length;if(!r.some(p=>c>=p.start&&c<p.end||g>p.start&&g<=p.end||c<=p.start&&g>=p.end)){f+=s.substring(d,c);let p=`<a href="#" class="vn-link" data-word="${y(a.toLowerCase())}">${o[0]}</a>`;f+=p;let m=f.length-p.length,w=f.length;r.push({start:m,end:w}),d=g}}f+=s.substring(d),s=f}return s}function j(e,t=[]){if(t.length===0)return y(e);let s=e.split(/(\s+)/),n="",r=0;return s.forEach(a=>{let l=r,u=r+a.length;t.some(([d,o])=>l<o&&u>d)?n+=`<strong>${y(a)}</strong>`:n+=y(a),r=u}),n}function N(e){let t="",s=!1,n=0;for(let r=0;r<e.length;r++){let a=e[r],l=e[r-1],u=a.isPunct,f=/[([{“"']$/.test(a.display),d=/^[)\]}”"',:;\.\?!]/.test(a.display),o=l?.isPunct,i=l&&/[([{“"']$/.test(l.display),c=l&&/^[)\]}”"',:;\.\?!]$/.test(l.display);if(a.isBold&&!s?(t+="<strong>",s=!0):!a.isBold&&s&&(t+="</strong>",s=!1),r>0){let g=!0;d||f||i?g=!1:(o&&!c||!o&&!u||c&&!u)&&(g=!0),g&&(t+=" ")}n===0&&/^\)/.test(a.display)||(u?(t+=a.display,/^\)/.test(a.display)?n--:/\($/.test(a.display)&&n++):a.inDictionary?t+=`<a href="#" class="vn-link" data-word="${y(a.key)}">${y(a.display)}</a>`:t+=y(a.display))}return s&&(t+="</strong>"),t}var x=[],H=[],b=null,E=null,$=null,C=null,F="v7";async function R(){[x,H]=await Promise.all([A(`./data/vnen.json.gz?v=${F}`),A(`./data/envn.json.gz?v=${F}`)]),b=new Map,x.forEach((e,t)=>{e._idx=t;let s=[e.searchable.lowercase,e.searchable.toneless,e.searchable.plain];for(let n of s)for(let r of n)b.has(r)||b.set(r,new Set),b.get(r).add(t)}),console.log(`Vietnamese index is ready: ${b.size} searchable terms for ${x.length} entries`),E=new Map,H.forEach((e,t)=>{e._idx=t;let s=e.lowercase;E.has(s)||E.set(s,[]),E.get(s).push(t)}),console.log(`English index is ready: ${E.size} searchable terms for ${H.length} lexemes`),$=new FlexSearch.Document({id:"_idx",document:{id:"_idx",store:!0,index:["gloss"]},tokenize:"forward",optimize:!0,resolution:9,depth:2,bidirectional:!1}),x.forEach((e,t)=>{e._idx=t;let s=[];e.lexemes&&Array.isArray(e.lexemes)&&e.lexemes.forEach(n=>{n.senses&&Array.isArray(n.senses)&&n.senses.forEach(r=>{r.gloss&&typeof r.gloss=="string"&&s.push(r.gloss.toLowerCase())})}),s.length>0&&$.add({_idx:t,gloss:s.join(" ")})}),C=new Set,x.forEach(e=>{e.searchable.lowercase.forEach(t=>C.add(t))})}function L(){return{vnEn:x,enVn:H,vnIndex:b,enIndex:E,glossDocIndex:$,vnHeadwordSet:C}}function T(e,t,s){return s[e].word.toLowerCase()===t}function ie(e){let{vnEn:t,vnIndex:s}=L();if(!s)return[];let n=P(e.trim().toLowerCase()),r=O(n),a=G(n),l=new Set,u=(o,i)=>{if(o.has(i))for(let c of o.get(i))l.add(c)},f=new Map;u(s,n),s.has(n)&&s.get(n).forEach(o=>{f.set(o,{exact:!0,startsWith:!0,length:t[o].word.length,canonical:T(o,n,t)})});let d=l.size>0;if(d||(u(s,r),s.has(r)&&s.get(r).forEach(o=>{f.has(o)||f.set(o,{exact:!1,startsWith:!0,length:t[o].word.length,canonical:T(o,n,t)})})),/^[a-zA-Z\s]+$/.test(e)&&(u(s,a),s.has(a)&&s.get(a).forEach(o=>{f.has(o)||f.set(o,{exact:!1,startsWith:!0,length:t[o].word.length,canonical:T(o,n,t)})})),l.size<10){let o=[n,r];/^[a-zA-Z\s]+$/.test(e)&&o.push(a);for(let[i,c]of s){let g;if(d?g=[n]:(g=[n,r],/^[a-zA-Z\s]+$/.test(e)&&g.push(a)),g.some(h=>new RegExp(`(^|\\s)${RegExp.escape(h)}`).test(i))){for(let h of c)if(l.add(h),!f.has(h)){let p=t[h].word.toLowerCase(),m=p.startsWith(n)||p.startsWith(r)||/^[a-zA-Z\s]+$/.test(e)&&p.startsWith(a);f.set(h,{exact:!1,startsWith:m,length:p.length})}}}}return Array.from(l).map(o=>({idx:o,...f.get(o)})).sort((o,i)=>{if(o.exact&&!i.exact)return-1;if(!o.exact&&i.exact)return 1;if(o.exact&&i.exact){if(o.canonical&&!i.canonical)return-1;if(!o.canonical&&i.canonical)return 1}if(o.startsWith&&!i.startsWith)return-1;if(!o.startsWith&&i.startsWith)return 1;if(o.length!==i.length)return o.length-i.length;let c=t[o.idx].rank||1/0,g=t[i.idx].rank||1/0;if(c!==g)return c-g;let h=t[o.idx].word,p=t[i.idx].word,m=t[o.idx].searchable.lowercase[0]||h.toLowerCase(),w=t[i.idx].searchable.lowercase[0]||p.toLowerCase();return m<w?-1:m>w?1:h===m&&p!==w?-1:p===w&&h!==m?1:0}).slice(0,20).map(o=>t[o.idx])}function le(e){let{enVn:t,enIndex:s}=L();if(!s)return[];let n=e.toLowerCase().trim();if(!n)return[];let r=new Set;s.has(n)&&s.get(n).forEach(l=>r.add(l));for(let[l,u]of s)l.startsWith(n)&&u.forEach(f=>r.add(f));return Array.from(r).map(l=>t[l]).sort((l,u)=>{let f=l.lowercase,d=u.lowercase;return f===n&&d!==n?-1:d===n&&f!==n?1:f.length-d.length}).slice(0,20)}function ce(e){let{vnEn:t,glossDocIndex:s}=L();if(!s)return[];let n=e.toLowerCase().trim();if(!n)return[];let r=s.search(n,{limit:100,enrich:!0,suggest:!0}),a=new Map;r.forEach(u=>{u.result&&Array.isArray(u.result)&&u.result.forEach(f=>{let d=t[f.id];if(!a.has(f.id)){let o=ue(d,n);o&&a.set(f.id,{word:d,score:o.score,matchedGloss:o.gloss})}})});let l=Array.from(a.values());return l.sort((u,f)=>f.score-u.score),l.slice(0,10).map(u=>u.word)}function de(e,t){let s=e.toLowerCase(),n=t.toLowerCase(),r=s.split(/;/).map(l=>l.trim()),a=0;for(let l of r){let u=l.split(/[,\s]+/).filter(p=>p.length>0),f=u.length,d=u.indexOf(n),o=u.findIndex(p=>p.startsWith(n)),i=l.includes(n),c=0;if(d!==-1){let p=d+1;c+=1e3/p}else if(o!==-1){let p=o+1;c+=500/p}else i&&(c+=50);let h=n.split(/\s+/).length/f;c*=1+h,f>8&&(c*=.5),a=Math.max(a,c)}return a}function ue(e,t){let s=null,n=0;if(!e.lexemes||(e.lexemes.forEach(a=>{a.senses&&a.senses.forEach(l=>{let u=l.gloss,f=de(u,t);f>n&&(n=f,s=u)})}),!s))return null;let r=n;return e.rank&&(e.rank<=1e3?r*=1.1:e.rank<=3e3&&(r*=1.05)),{gloss:s,score:r}}function V(e){if(!e.trim())return{type:"empty"};let t={type:"combined",vnHeadwords:[],enHeadwords:[],enGlosses:[]};t.vnHeadwords=ie(e),t.enHeadwords=le(e);let s=t.vnHeadwords.length>0||t.enHeadwords.length>0,n=t.enHeadwords.some(a=>a.lowercase===e.toLowerCase().trim());return/^[a-zA-Z ]+$/.test(e)&&!n&&(t.enGlosses=ce(e),t.enGlosses.length>0&&(t.type="includes-reverse")),!s&&!t.enGlosses.length?{type:"none"}:t}function q(e,t=[]){let{vnHeadwordSet:s}=L(),n=Array.isArray(t)?t.slice().sort((i,c)=>i[0]-c[0]).filter(([i,c])=>i>=0&&c>i&&c<=e.length):[],r=e.match(/[\p{L}\p{N}-]+|\s+|[^\p{L}\p{N}\s-]+/gu)||[],a=0,l=r.map(i=>{let c=a,g=c+i.length;a=g;let h=/\p{L}/u.test(i),p=n.some(([m,w])=>c<w&&g>m);return{text:i,isWord:h,isSpace:/^\s+$/.test(i),isPunct:!h&&!/^\s+$/.test(i),isBold:p}}),u=l.filter(i=>i.isWord).map(i=>i.text),f=u.map(i=>i.toLowerCase()),d=0,o=[];for(let i=0;i<l.length;i++){let c=l[i];if(c.isSpace){o.push({display:c.text,key:null,isPunct:!1,isSpace:!0,inDictionary:!1,isBold:c.isBold});continue}if(c.isPunct){o.push({display:c.text,key:null,isPunct:!0,isSpace:!1,inDictionary:!1,isBold:c.isBold});continue}let g=null,h=null,p=0;for(let m=u.length;m>d;m--){let w=f.slice(d,m).join(" ");if(s.has(w)){h=w,g=u.slice(d,m).join(" "),p=m-d;break}}if(g){o.push({display:g,key:h,isPunct:!1,isSpace:!1,inDictionary:!0,isBold:l[i].isBold});let m=0;for(let w=i;w<l.length&&m<p;w++)l[w].isWord&&m++,i=w;d+=p}else{let m=u[d];o.push({display:m,key:f[d],isPunct:!1,isSpace:!1,inDictionary:!1,isBold:c.isBold}),d++}}return o}Handlebars.registerHelper("join",function(e,t){return e?e.join(t):""});Handlebars.registerHelper("eq",function(e,t){return e===t});Handlebars.registerHelper("linkifyFromList",function(e,t){return new Handlebars.SafeString(U(e,t))});Handlebars.registerHelper("linkify",function(e,t){let s=Array.isArray(t)?t:[],n=q(e,s);return new Handlebars.SafeString(N(n))});Handlebars.registerHelper("boldify",function(e,t){return new Handlebars.SafeString(j(e,t))});Handlebars.registerHelper("rankBadge",function(e){return e?e<=1e3?'<span class="rank-badge core">Top 1000</span>':e<=3e3?'<span class="rank-badge common">Top 3000</span>':e<=5e3?'<span class="rank-badge general">Top 5000</span>':"":""});Handlebars.registerHelper("audioButton",function(e,t){return`
    ...
    `});Handlebars.registerHelper("gt",(e,t)=>e>t);Handlebars.registerHelper("lte",(e,t)=>e<=t);Handlebars.registerHelper("and",(e,t)=>e&&t);var Z=Handlebars.compile(`
<div class="result">
...
`);function S(e,t,s=!0){let n=e.toLowerCase().replace(/\s+/g,"-");return`
